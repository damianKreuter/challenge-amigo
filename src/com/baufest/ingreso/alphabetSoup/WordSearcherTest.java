...
public class WordSearcherTest {
    ...
    private WordSearcher wordSearcherMINI;

    @Before
    public void before() {
        wordSearcher = new WordSearcher(alphabetSoup);
        wordSearcherMINI = new WordSearcher(alphabetSoup2);
    }
/*
    @Test
    public void testEstaMARCA() {
        assertTrue(wordSearcherMINI.isPresent("MARCAPAS"));
    }
  */
    @Test
